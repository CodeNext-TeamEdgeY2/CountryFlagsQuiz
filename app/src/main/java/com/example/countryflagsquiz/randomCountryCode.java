...
public class randomCountryCode {
    ...
    static final Map<String, String> map = new TreeMap<String, String>(String.CASE_INSENSITIVE_ORDER);
    ...
    public static String getRandomCountryCode(){
        ...
        Log.d(TAG, "getRandomCountryCode: " + Arrays.toString(values));
        String randomValue = (String) values[myRandomizer.nextInt(values.length)];
        Log.d(TAG, "getRandomCountryCode: " + randomValue);
        return randomValue;
    }

    public static String getRandomCountryName(){
        String randomCountryName = map.get(Math.random());
